...
class Securimage {
	...
	*/
	...
	function Securimage()
	{
		...
		$this->ttf_file      = d('./images/fonts/AHGBold.ttf');
	...
	function saveData()
	{
		...
		common::setcookie('securimage_code_value',strtolower($this->code));
		common::setcookie('securimage_code_ctime',$timestamp);
	...
	function validate()
	{
		...
		if (isset($cookie['securimage_code_value']) && trim($cookie['securimage_code_value']) != '') {
			if ($this->isCodeExpired($cookie['securimage_code_ctime']) == false) { 
			  $code = $cookie['securimage_code_value'];
			}
		...
		if ($code != '') {
			if ($code == $code_entered) {
			  ...
			  common::setcookie('securimage_code_value','');
			  common::setcookie('securimage_code_ctime','');
