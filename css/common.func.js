...
function dmhaddbank(hash,mobil,cashtype){
	 comm_fram(413, 235, "添加提现卡号", "", "<form id=qtform action='/member/addcasher/' method=post name=myform><div> $sys_hash_code2 </div><div style='height:200px;margin:0px 10px;'><div style='height:150px;font-size:13px;'><p style='height:25px;'>　您的提现银行：<select name='bankType' style='width:155px;color:#333;'><option value='icbc'>中国工商银行</option><option value='boc'>中国银行</option><option value='ccb'>中国建设银行</option><option value='cmb'>中国招商银行</option><option value='comm'>中国交通银行</option><option value='abc'>中国农业银行</option></select></p><p style='height:25px;'>　　　真实姓名：<input type='text' name='truename' style='text-indent:3px;width:220px;color:#999;' maxlength='7' id='truename' value='如银行户名：李四' onclick='if(this.value==\"如银行户名：李四\")this.value=\"\";' onblur='if(this.value==\"\")this.value=\"如银行户名：李四\";'></p><p>　您的银行账号：<input type='text' name='bankId' id='bankId' maxlength='26' style='text-indent:3px;width:250px;color:#999;' value='如银行账号：6222023100032381111' onclick='if(this.value==\"如银行账号：6222023100032381111\")this.value=\"\";' onblur='if(this.value==\"\")this.value=\"如银行账号：6222023100032381111\";'></p><p style='height:25px;'>银行卡开户地：<input type='text' name='bankAddress' id='bankAddress' maxlength='26' style='text-indent:3px;width:250px;color:#999;' value='' /></p><p style='height:25px;'>　　　　操作码：<input type='password' name='password2' id='pwd3' style='color:#999;'></p><p>　　　　　　　　</p></div><p class='btn' style='text-align:right;'><input type='hidden' value="+hash+" name='hash2'><input type='hidden' value='bank' name='type'><input type='submit' class='btn_em' value='立即绑定'><input onclick='doCut();' class=btn_dft type='button' tabindex='9' value='取 消'></p></div></form>");
	}
