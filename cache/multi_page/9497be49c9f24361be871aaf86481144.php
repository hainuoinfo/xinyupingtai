<?php $html="
				...
				<a href=\"".(($minpage)==$minpage&&$url_default?$url_default:($urls[0].($minpage).$urls[1]))."\" class=\"page\">首 页</a>
				<a href=\"".(($page-1)==$minpage&&$url_default?$url_default:($urls[0].($page-1).$urls[1]))."\" class=\"page\">上一页</a>
				";};$html.="
