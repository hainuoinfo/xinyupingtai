<?php $_tplModify=filemtime('D:\damaihu\xinyupingtai7\cache\default\founder\sys_credits.php');if(filemtime('D:\damaihu\xinyupingtai7\templates\default\founder\h.htm')>$_tplModify||filemtime('D:\damaihu\xinyupingtai7\templates\default\founder\header.htm')>$_tplModify||filemtime('D:\damaihu\xinyupingtai7\templates\default\founder\f.htm')>$_tplModify||filemtime('D:\damaihu\xinyupingtai7\templates\default\founder\footer.htm')>$_tplModify){include(template::load_base('D:\damaihu\xinyupingtai7\templates\default\founder\sys_credits.htm','D:\damaihu\xinyupingtai7\cache\default\founder\sys_credits.php',true));exit;}?><?php !defined("IN_JB")&&exit("error");$__tplUrl = '/templates/default/founder/';echo '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
var add = function(){';echo '
	$(\'#tbList\').append(\'<tr class="hover"><td></td><td><input type="text" name="credit[]" class="txt" style="width:60px" /></td><td><input type="text" name="icon[]" class="txt" style="width:240px" /></td><td><input type="text" name="title[]" class="txt" /></td><td><a href="javascript:" onclick="$(this).parent().parent().remove()">移除</a></td></tr>\');
';echo '};
</script>
...
';echo $sys_hash_code;echo '
	<table class="tb tb2 fixpadding">
		<tr>
			<th colspan="5" class="partition">技巧提示</th>
		</tr>
		<tr>
			<td colspan="5" class="tipsblock"><ul id="tipslis">
					<li>最小积分为进入该等级的最小积分</li>
				</ul></td>
		</tr>
		...
		';if($levels){foreach($levels as $k=>$v){echo '
		<tr class="hover">
			<td>';echo $k+1;echo '</td>
			<td><input type="text" name="credit[]" class="txt" value="';echo $v['credit'];echo '" style="width:60px" /></td>
		...
		<tr>
			<td><a href="javascript:;" onclick="add()">添加一个等级</a></td>
