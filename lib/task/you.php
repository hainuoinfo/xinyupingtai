...
error::bbsMsg('由于百度有啊已经倒闭，有啊区已经取消！');
$m || $m = 'index';
...
$complateCount = db::data_count('task', "type='$taskId' and status='8'");
if ($m == 'index') {
	$bbsNav[] = $pName;
} else {
...
switch ($m) {
	...
	case 'add':
		...
		if ($rs = form::is_form_hash2()) {
			$datas = form::get('nickname', 'itemurl', 'visitTip', 'visitKey', array('visitWay', 'int'), array('price', 'float'), array('isPriceFit', 'int'), array('pointExt', 'float'), array('times', 'int'),  array('scores', 'int'), array('isRemark', 'int'), 'remark', array('isShare', 'int'), array('share', 'int'), 'tips', array('isVerify', 'int'), array('isLimit', 'int'), array('limit', 'int'), array('isReal', 'int'), array('isChat', 'int'), array('isChatDone', 'int'), array('isScore', 'int'), array('scoreLvl', 'int'), array('isCredit', 'int'), array('creditLvl', 'int'), array('isGood', 'int'), array('goodLvl', 'int'), array('isBlack', 'int'), array('blackLvl', 'int'), array('isFame', 'int'), array('fameLvl', 'int'), array('isPlan', 'int'), 'planDate');
			if ($rs === true) {
				$rs = task_pai::add($datas, $uid);
			}
			if ($rs === true) {
				//保存模板
	...
	case 'adds':
		...
		checkPwd2();
		if ($rs = form::is_form_hash2()) {
			$datas = form::get2('nickname', 'itemurl', array('price', 'float'), array('isPriceFit', 'int'), array('pointExt', 'float'), array('times', 'int'),  array('scores', 'int'), array('isRemark', 'int'), 'remark', array('isShare', 'int'), array('share', 'int'), 'tips', array('isVerify', 'int'), array('isLimit', 'int'), array('limit', 'int'), array('isCart', 'int'), array('isAddress', 'int'), 'address', array('isExpress', 'int'), array('expressTM', 'int'), array('isReal', 'int'), array('isChat', 'int'), array('isChatDone', 'int'), array('isScore', 'int'), array('scoreLvl', 'int'), array('isCredit', 'int'), array('creditLvl', 'int'), array('isGood', 'int'), array('goodLvl', 'int'), array('isBlack', 'int'), array('blackLvl', 'int'), array('isFame', 'int'), array('fameLvl', 'int'), array('isPlan', 'int'), 'planDate');
			if ($rs === true) {
