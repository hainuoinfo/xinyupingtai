    ...
    if( curG < 1 ){
        ...
        $("#btnCilentAdd").click(function(){
			...
			if($("#rshop").is(':checked'))
			  {
			  destype='店铺';
			  }else if ($("#rtrains").is(':checked')){ 
			  destype='直通车';
			  }else if ($("#rcredits").is(':checked')){ 
			  destype='信用评价';
			  }else{ 
			  destype='商品';
			  }
