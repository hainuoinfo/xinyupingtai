<?php $_tplModify=filemtime('D:\damaihu\xinyupingtai7\cache\default\task\tao_index.php');if(filemtime('D:\damaihu\xinyupingtai7\templates\default\headerBase.htm')>$_tplModify||filemtime('D:\damaihu\xinyupingtai7\templates\default\task\tao_info.htm')>$_tplModify||filemtime('D:\damaihu\xinyupingtai7\templates\default\quick.htm')>$_tplModify||filemtime('D:\damaihu\xinyupingtai7\templates\default\task\tab.htm')>$_tplModify||filemtime('D:\damaihu\xinyupingtai7\templates\default\footer.htm')>$_tplModify){include(template::load_base('D:\damaihu\xinyupingtai7\templates\default\task\tao_index.htm','D:\damaihu\xinyupingtai7\cache\default\task\tao_index.php',true));exit;}?><?php !defined("IN_JB")&&exit("error");$__tplUrl = '/templates/default/task/';$cssList=array(0=>'http://damaihu.tertw.net/css/task/task.css');echo '
