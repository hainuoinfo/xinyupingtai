<?php $_tplModify=filemtime('D:\damaihu\xinyupingtai7\cache\default\member\reg.php');if(filemtime('D:\damaihu\xinyupingtai7\templates\default\regheader.htm')>$_tplModify||filemtime('D:\damaihu\xinyupingtai7\templates\default\service.htm')>$_tplModify||filemtime('D:\damaihu\xinyupingtai7\templates\default\footer.htm')>$_tplModify){include(template::load_base('D:\damaihu\xinyupingtai7\templates\default\member\reg.htm','D:\damaihu\xinyupingtai7\cache\default\member\reg.php',true));exit;}?><?php !defined("IN_JB")&&exit("error");$__tplUrl = '/templates/default/member/';echo '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<form method="post" name="loginForm" id="loginForm" onsubmit="return checkForm();" action="/">

	<ul id="login_list" style="border:none;width:440px;padding-left:50px;">
