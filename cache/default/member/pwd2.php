<?php $_tplModify=filemtime('D:\damaihu\xinyupingtai7\cache\default\member\pwd2.php');if(filemtime('D:\damaihu\xinyupingtai7\templates\default\headerBase.htm')>$_tplModify||filemtime('D:\damaihu\xinyupingtai7\templates\default\footer.htm')>$_tplModify){include(template::load_base('D:\damaihu\xinyupingtai7\templates\default\member\pwd2.htm','D:\damaihu\xinyupingtai7\cache\default\member\pwd2.php',true));exit;}?><?php !defined("IN_JB")&&exit("error");$__tplUrl = '/templates/default/member/';$title='请输入操作码 - 互动吧平台';$keywords='';$description='';$cssList=array(0=>'http://damaihu.tertw.net/css/member/info.css',1=>'http://damaihu.tertw.net/css/member/member.css');echo '
...
<div id="content" style="height:395px; padding-top:35px;">
	<form name="myForm" method="post" id="myForm" onsubmit="return checkForm1();">
	<div>';echo $sys_hash_code2;echo '</div>
    <input name="referer" value="';echo $referer;echo '" type="hidden">
    <div class="aqm_bk">
		<h4 class="aqm_tit2">输入安全操作码</h4>
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody><tr>
            <td style="font-size:13px;" align="right" height="40" width="30%"><strong>安全操作码：</strong></td>
            <td><input name="password2" class="aqm_inp" id="password2" type="password"></td>
          </tr>
         <tr>
                <td Color="red">';if($errMsg){echo '<center>';echo $errMsg;echo '</center>';}echo '</td>
                <td></td>
              </tr>
          <tr>
            <td align="right" height="40">&nbsp;</td>
            <td>
            <input name="btnSubmit" class="aqm_szcg2" type="submit" >
            <a href="';if(!$web_rewrite)echo $weburl2.'rewrite.php?rewrite=';echo '/member/userdata/?type=GetPass" class="aqm_szcg3"></a>
            </td>
          </tr>
        </tbody></table>
	</div>
	...
	<form name="myForm" method="post" id="myForm" onsubmit="return checkForm2();">
	<div>';echo $sys_hash_code2;echo '</div>
	<input name="from_clientId" value="clientId" type="hidden">
	<input name="reset" value="1" type="hidden">
	 <div class="aqm_bk" id="aqm_bk" style="display:none;">
		<h4 class="aqm_tit2">请设置您的安全操作码</h4>
		
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tbody>
		  <tr>
            <td style="font-size:13px;" align="right" height="40" width="30%">
			<strong>安全操作码：</strong>
			</td>
            <td><input name="password2" id="password2" class="aqm_inp" type="password"></td>
          </tr>
          <tr>
            <td style="font-size:13px;" align="right" height="40"><strong>安全操作码确认：</strong></td>
            <td><input name="password2_" id="password2_" class="aqm_inp" type="password"></td>
          </tr>
          <tr>
            <td align="right" height="40">&nbsp;</td>
            <td><input class="aqm_szcg" type="submit"></td>
          </tr>
        </tbody>
		</table>
	</div>
...
';echo '}
function showaqm(){';echo '
    $(\'#aqm_bk\').css({';echo 'display:"block"';echo '});
	$(\'#aqm_bk1\').css({';echo 'display:"none"';echo '});
';echo '}
